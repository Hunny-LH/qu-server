...
function deleteTs(tid){
	if(confirm("你确定取消该条推荐标签吗?")){
		form1.action="tag.do?method=deleteTsHot&type=1&tid="+tid;
		form1.submit();
	}
}
  ...
  <div id="Content">
   <%@ include file="left.jsp"%>
    <div id="Right" class="clearfix">
      ...
      <div class="content">
        <div class="tab"> <a href="tag.do?method=editerTagList"  >标签列表</a> <a href="tag.do?method=hotList" class="on">推荐列表</a> <a href="tag.do?method=hotImageList">推荐图片标签列表</a></div>
