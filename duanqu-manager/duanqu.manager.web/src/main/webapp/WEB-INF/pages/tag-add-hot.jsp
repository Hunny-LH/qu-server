...
if(document.form2.imageUrl.value==""){
	alert("请输入图片");
	return false;
}
form2.submit();
...
<div class="updiv">
  <form id="form2" name="form2" method="post" enctype="multipart/form-data" action="tag.do?method=saveHotTag">
  	<input type="hidden" name="tid" id="tid" value="${tid}">
    <table width="400" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td height="31" align="right" >图片：</td>
      <td><label for="fileField"></label>
        <input type="file" name="imageUrl" id="fileField" class="input-text" /></td>
    </tr>
      <tr>
