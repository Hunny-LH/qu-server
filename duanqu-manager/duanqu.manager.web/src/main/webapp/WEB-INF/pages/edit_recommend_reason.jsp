...
function saveReason(){
   ...
   // disButton();
    ...
    DemoController.updateRecommendReason(uid,$("#type").val(),reason,function(data)
	{  
...
<form id="form2" name="form2" method="post" action="user.do?method=saveMessage">
	<input type="hidden" name="uid" value="${userRecommendModel.uid}" id="uid"/>
	<input type="hidden" name="type" value="${userRecommendModel.type}" id="type"/>
  <table width="400" border="0" cellpadding="0" cellspacing="0">
  
    <tr>
      <td width="87" height="44" align="right">&nbsp;</td>
      <td width="313"><label for="textarea"></label>
        <textarea name="reason"   required class="input-text" id="textarea" placeholder="" style="width:350px;height:100px">${reason}</textarea></td>
    </tr>
    <tr>
      <td align="right" valign="top" >&nbsp;</td>
      <td><input name="button" type="button" class="button" id="button" onClick="saveReason()" value="保 存" /></td>
    </tr>
  </table>
</form>
</body>
